...
if __name__ == "__main__":
    ...
    if os.path.exists('Output/RealUniNets/RealUniNets_2.pkl'):
        df_already = pd.read_pickle('Output/RealUniNets/RealUniNets_2.pkl')
    ...
    if os.path.exists('Output/RealUniNets/RealUniNets_2.pkl'):
        df2 = pd.read_pickle('Output/RealUniNets/RealUniNets_2.pkl')
        df = pd.concat([df, df2])
        save_name_html = 'RealUnipartiteNets_2_results'
        write_html(df, save_name_html)
        df.to_pickle('Output/RealUniNets/RealUniNets_2.pkl')
    else:
        df.to_pickle('Output/RealUniNets/RealUniNets_2.pkl')
